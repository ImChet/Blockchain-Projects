...
CONTRACT_ADDRESS=$(grep -oE '0x[a-fA-F0-9]{40}' build/contracts/TokenManager.json | tail -2 | head -1)
echo "TokenManager contract deployed at $CONTRACT_ADDRESS"
